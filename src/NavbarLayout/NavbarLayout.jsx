  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-8 dark:text-white max-xl:hidden">
              ...
              <span
                ...
                className="flex gap-[6px] items-center cursor-pointer group"
              >
      ...
      shadow-sm duration-300 after:duration-300 after:shadow-md"
            ...
            <div className="flex items-center gap-4 xl:hidden">
              ...
              <div className="relative group  py-[4px] pl-[12px] px-[6px] dark:bg-white border rounded-lg hover:bg-slate-100 duration-200">
                <p
                  className="flex items-center text-lg font-medium cursor-pointer"
                  onClick={() => setIsOpen(!isOpen)}
                >
                ...
                {isOpen && (
                  <div className="absolute top-full left-0 mt-2 w-[105px] bg-white rounded-lg border border-gray-300 shadow-lg">
                    <p
                      onClick={(e) => onchangeLanguage(e, "uz")}
                      className="cursor-pointer text-lg font-semibold text-center py-1 hover:bg-gray-300 dark:hover:bg-[#5f5f5f]"
                    >
    ...
    shadow-sm duration-300 after:duration-300 after:shadow-md"
              ...
              <button onClick={() => setMenuOpen(!isMenuOpen)}>
                <IoMenu className="text-black dark:text-white" size={34} />
              </button>
            </div>
          </div>
          {isMenuOpen && (
            <div className="fixed top-0 left-0 flex flex-col items-center justify-center w-full h-screen space-y-8 text-white bg-black bg-opacity-90">
              <div className="relative flex flex-col items-center justify-center h-full gap-20 mt-44 dark:text-white">
                <button
                ...
                <ul className="flex flex-col gap-8 text-lg text-center">
                ...
                <span className="flex gap-[6px] items-center mb-80 cursor-pointer group">
                  <h2 className="text-[20px] font-semibold dark:group-hover:text-white">
                    +998 88
                  </h2>
                  <h2 className="text-xl font-semibold">434 78 08</h2>
                </span>
