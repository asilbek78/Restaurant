      ...
      <div className="dark:bg-gray-900 ">
        <div className="container h-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 pb-10 mt-8 w-[91%] mx-auto">
            {eight?.dengiztaomlari?.map((item, id) => (
              <div
                key={id}
                data-aos="zoom-in"
              ...
              >
                <img
                  className="w-full group-hover:scale-105 duration-300 bg-cover max-h-48 border rounded-lg"
                  src={item.img}
                  alt=""
                />
