      ...
      <div className="dark:bg-gray-900">
        <div className=" container h-auto">
          <span className="flex justify-center ">
            <h1
              data-aos="fade-down"
              className="dark:text-white text-[40px] font-semibold text-gray-700 mt-5"
            >
              {t("menu.h2")}
            </h1>
          </span>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 pb-10 mt-8 w-[91%] mx-auto">
            {eight?.turktaomlar?.map((item, id) => (
              <div
                key={id}
                data-aos="zoom-in"
                className="gap-2 hover:shadow-md dark:bg-[#0f152a] hover:shadow-black h-[450px] max-w-[350px] bg-white group border rounded-lg shadow-sm shadow-black flex flex-col p-4"
              >
                <img
                ...
                <div className="flex flex-col justify-between h-full">
                  ...
                  <Link to={`/turk/${item.url}`}>
                    <button
                      className="z-0 font-sans flex justify-center gap-3 items-center mx-auto shadow-xl text-lg text-gray-50 bg-[#111431] 
                  ...
                  px-5 py-[9px] overflow-hidden border-2 rounded-full group"
                      type="submit"
                    >
                    ...
                    group-hover:border-gray-700 p-2 rotate-45"
                      >
                        <path
