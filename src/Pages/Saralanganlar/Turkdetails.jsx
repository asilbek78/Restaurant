...
function Turkdetails() {
  const { details: paramname } = useParams();
  const { data, isLoading } = UseFetch("https://omvwbniuooqqvunluhkz.supabase.co/storage/v1/object/sign/db/db.json?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJkYi9kYi5qc29uIiwiaWF0IjoxNzQyODg4ODk2LCJleHAiOjE3NzQ0MjQ4OTZ9.NV0T1LNduVjHMtwonR04cVgRfKQSXTw0O52a-Qp5izE/public/db.json");
  ...
  const item = data?.turktaomlar?.find((el) => el.url === paramname);
  ...
  return (
    <div className="dark:bg-gray-900 bg-gray-100">
      ...
      <div className=" mx-auto py-24 w-[87%] flex justify-around items-center">
        <img
          src={item.img}
          alt="mn"
        ...
        <article className="flex flex-col max-w-[47%] gap-5">
          ...
          <article className="flex gap-6">
            <button
              ...
              className="cursor-pointer transition-all bg-blue-500 text-white font-semibold px-9 py-3 rounded-lg border-blue-600 border-b-[4px] hover:brightness-110 hover:-translate-y-[1px] active:border-b-[2px] active:brightness-90 active:translate-y-[2px]"
            >
            ...
            >
              ...
              <p className="translate-x-4 text-gray-950 font-semibold">
                {t("menu.btn")}
              </p>
            </button>
          </article>
