...
function Yapondetails() {
  ...
  const item = data?.yapontaomlar?.find((el) => el.url === paramname);
  ...
  return (
    <div className="dark:bg-gray-900 bg-gray-100">
      <div className="container mx-auto py-24 w-[85%] flex justify-around items-center">
        <img
          src={item.img}
          alt="mn"
