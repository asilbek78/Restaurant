  ...
  return (
    <div className="dark:bg-gray-900">
      <div className="container mx-auto p-8">
        <h2 className="text-4xl font-bold text-center mb-10 text-orange-400 dark:text-yellow-400">
          {t("vac.h1")}
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {vacancies.map((item, id) => (
            <div
              key={id}
              className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl duration-300 shadow-lg transform transition-all hover:scale-105 hover:shadow-xl"
            >
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white flex items-center">
                {item.title[i18n.language]}
              </h3>
              <p className="text-md dark:text-gray-400 mt-1">
                🔹 {item.type[i18n.language]} {t("vac.h2")}
              </p>
              <p className="text-xl dark:text-green-400 font-medium mt-3">
