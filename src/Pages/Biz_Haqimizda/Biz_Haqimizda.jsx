    ...
    <>
      ...
      <div className="  pt-[35px] dark:bg-gray-900 bg-slate-50 pb-10 h-auto ">
        <div className="container">
          <Secondabout />
          <div className="lg:w-[80%] md:w-[88%] h-auto m-auto">
            <article className="flex flex-col gap-4 mt-10 mb-14">
              <h1 data-aos="fade-right" className="font-semibold text-gray-600 lg:text-3xl dark:text-yellow-400 sm:text-2xl">
                {t("about.h1")}
              </h1>
              <p data-aos="fade-right" className=" lg:text-md text-gray-800 max-w-[990px] font-medium dark:text-gray-300">
                {t("about.p1")}
              </p>
              <p data-aos="fade-right" className=" text-md text-gray-800 max-w-[990px] dark:text-gray-300 font-medium">
                {t("about.p2")}
              </p>
            </article>
            <div className=" bg-sl ate-100 dark:bg-gray-800 flex flex-col items-center gap-8 transition duration-300 border rounded-xl max-w-[1000px] pt-5 pb-7 shadow-sm shadow-gray-600 hover:shadow-md hover:shadow-gray-500">
              <span data-aos="fade-up-right" className=" max-w-[890px] flex flex-col gap-3">
              ...
              <div data-aos="fade-up-left" className="max-w-[900px] overflow-hidden">
                <Swiper
                  slidesPerView={3}
                  spaceBetween={15}
                  autoplay={{
            ...
            <article className="flex flex-col gap-4 mb-3 mt-14">
              <h1 data-aos="fade-right" className="text-3xl font-semibold text-gray-600 dark:text-yellow-400">
                {t("about.h3")}
              </h1>
              <p  data-aos="fade-right" className=" text-md text-gray-800 max-w-[990px] font-medium dark:text-gray-400">
                {t("about.p4")}
              </p>
              <p data-aos="fade-right" className=" text-md text-gray-800 max-w-[990px] font-medium dark:text-gray-400">
                {t("about.p5")}
