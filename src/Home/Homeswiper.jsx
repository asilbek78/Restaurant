...
function Homeswiper() {
  ...
  const { data: two, isLoading } = UseFetch("https://omvwbniuooqqvunluhkz.supabase.co/storage/v1/object/sign/db/db.json?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJkYi9kYi5qc29uIiwiaWF0IjoxNzQyODg4ODk2LCJleHAiOjE3NzQ0MjQ4OTZ9.NV0T1LNduVjHMtwonR04cVgRfKQSXTw0O52a-Qp5izE");
    ...
    <div className="dark:bg-gray-900 ">
      <div className="p-4 container ">
        ...
        <article className="flex text-center pb-9">
          <h1 className="container text-[27px] font-semibold dark:text-yellow-400" data-aos="fade-up">
            {t("homeh1.nom")}
          </h1>
              ...
              >
                ...
                <div className="flex flex-col gap-1 mt-3">
                  ...
                  <article className="flex justify-center">
                    ...
                    <button className="dark:bg-gray-800 dark:text-white dark:hover:bg-gray-900 mt-1 px-5 bg-slate-300 p-2 w-[100%] text-lg font-sans border rounded-md hover:bg-[#FFB84D] hover:text-white transition duration-300">
