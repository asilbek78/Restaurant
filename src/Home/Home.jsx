...
function Home() {
  ...
  return (
    <>
      {isLoading && <h1></h1>}
      <div className=" bgi w-[100%] xl:!h-[88vh] lg:!h-[800px] md:!h-[850px]">
      <div
              ...
              <Link to={"/menu"}>
                <div className="flex items-center justify-center scale-95 ">
                  <div className="relative group">
                    <button className="relative inline-block p-px font-semibold leading-6 text-white transition-transform duration-300 ease-in-out bg-gray-800 shadow-2xl cursor-pointer dark:bg-gray-400 rounded-xl shadow-zinc-900 hover:scale-105 active:scale-95">
                      <span className="absolute inset-0 rounded-xl bg-gradient-to-r from-teal-400 via-blue-500 to-purple-500 p-[2px] opacity-0 transition-opacity duration-500 group-hover:opacity-100"></span>

                      <span className="relative z-10 block px-6 py-3 bg-gray-800 rounded-xl">
      ...
      <Homeswiper />
      <Firsthome />
      <div className="pt-10 pb-11 dark:bg-gray-900">
        <div className="container flex flex-col items-center gap-4 mb-3">
          <h1  data-aos="fade-right" className="mb-2 text-3xl font-semibold text-gray-800 dark:text-yellow-400">
            {t("home.h1")}
          </h1>
